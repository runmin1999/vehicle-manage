...
public interface UserManageDao {
    ...
    @Delete("delete from tab_user_role " +
            "where userId = (select id from tab_user where username = #{username})")
    void delUserRole(@Param("username") String username);

    @Delete("delete from tab_user where username = #{username}")
    void delUserName(@Param("username") String username);
//
//    @Select("select id from tab_user where username = #{username}")
//    Integer findRoleId(@Param("username")String username);
}
