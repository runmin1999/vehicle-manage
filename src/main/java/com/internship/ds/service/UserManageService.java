...
public class UserManageService {
    ...
    public JSONObject delUserBase(String request) {
        val p = Objects.requireNonNull(JSON.parseObject(request));
        String username = Objects.requireNonNull(p.getString("username"));
        userManageDao.delUserRole(username);
        userManageDao.delUserName(username);
        return null;
    }
}
